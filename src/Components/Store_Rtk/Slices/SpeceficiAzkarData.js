...
export const fetchSpecificAzkar = createAsyncThunk(`SpecificAzkarData/fetchSpecificAzkar`, async (obj = { url: "http://www.hisnmuslim.com/api/ar/27.json", title: "أذكار الصباح والمساء" }) => {
